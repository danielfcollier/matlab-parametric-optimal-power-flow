...
% UHE Salto Osorio
nm(1)=6;                     % max=6
aux1=[1.80 1.78 1.76 1.72 1.70 1.68];
aux2=0.90*ones(1,6);
aux3=[1.04 1.02 1.00 0.98 0.96 0.94];
aux4=0.70*ones(1,6);
n=nm(1);
sn=[sn aux1(1:n)];
fp=[fp aux2(1:n)];
...
fp=[fp zeros(1,6-3-1)];
xs=[xs zeros(1,6-3-1)];
qmax=[qmax zeros(1,6-3-1)];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% UTE Jorge Lacerda
nm(6)=7;                     % max=7   
aux1=[1.04 1.00 3.30 2.38 2.36 1.700 1.720];
aux2=[0.95 0.95 0.97 0.95 0.95 0.975 0.975];
aux3=[1.22 1.20 0.90 0.80 0.82 1.020 0.980];
aux4=[0.35 0.35 3.00 0.90 0.90 0.500 0.500];
n=nm(6);
sn=[sn aux1(1:n)];
fp=[fp aux2(1:n)];
xs=[xs aux3(1:n)];
...
qmax=[qmax zeros(1,13-6-1)];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% UHE ?
nm(13)=4;                     % max=4   
aux1=[3.58 3.56 3.54 3.52];
aux2=0.975*ones(1,4);
aux3=[0.74 0.72 0.70 0.68];
aux4=1.05*ones(1,4);
n=nm(13);
sn=[sn aux1(1:n)];
fp=[fp aux2(1:n)];
...
vmax(2)=vmin(2);
vmax(18)=vmin(18);
qgmax(8)=0.1; qgmin(8)=0.1;
qgmax(29)=-1.074; qgmin(29)=-1.074;
qgmax(30)=-1.082; qgmin(30)=-1.082;
qgmax(31)=-1.112; qgmin(31)=-1.112;
qgmax(32)=-1.15; qgmin(32)=-1.15;
qgmax(56)=-1.12; qgmin(56)=-1.12;
qgmax(33)=qgmin(33);
